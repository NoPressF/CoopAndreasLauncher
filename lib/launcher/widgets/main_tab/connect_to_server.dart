...
class _ConnectToServerTabState extends State<ConnectToServerTab> {
  ...
  void onPressedConnectButton({bool debug = false}) async {
    ...
    _lastLaunchResult = await StartGame.tryStartGame(debug: debug);
        ...
        children: [
              ...
              children: [
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                        ...
                        labelStyle: TextStyle(
                            ...
                            color: !FieldsManipulate.isValidEx(Field.nickName,
                                    ExtendedField.connectPressed)
                                ? Colors.red
                ...
                Padding(
                  ...
                  child: TextField(
                    ...
                    focusNode:
                        FieldsManipulate.getFocusNode(Field.connectIpPort),
                    undoController: undoHistoryController,
          ...
          Row(
            ...
            children: [
              ...
              SizedBox(width: 7),
              TextButton(
                  onPressed: () => onPressedConnectButton(debug: true),
                  child: Text('Debug',
                      style: TextStyle(
                          color: !themeProvider.isDarkMode
                              ? Colors.white
