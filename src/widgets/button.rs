...
use crate::utils::colors::LauncherColors;
...
fn button<T: druid::Data + 'static>(
    ...
    let button = Button::new(label)
        ...
        .env_scope(|env: &mut Env, _| {
            env.set(theme::BUTTON_DARK, LauncherColors::ButtonLightGrey);
            env.set(theme::BUTTON_LIGHT, LauncherColors::ButtonLightGrey);
